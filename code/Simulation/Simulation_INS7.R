####
# This simulation is to compare the performance of the weighted estimator under different option.
...
results_3 <- lapply(c(0,1,-1,0.5), FUN= function(x){
...
FigData3 <- data.frame(par=rep(parnames,3),response=rep(response0,3),Results,Val="Internal")
