...
re1 <- INS_int(1,nsample=1500, nvalidation=500)
...
# save(results_3,file="WINV_R4_1.RData")
load("WINV_R4_1.RData")
...
reference1 <- c(0.029,0.014, 0.027, 0.140,0.121, 0.147)
# save(Results2,file="WINV_RTable4.RData")
load("WINV_RTable4.RData")
library(xtable)
...
# load("P:/Work/waterloo/2018/GEEmix/WINV_RTable31.RData")
# Results2 <- Results
# load("P:/Work/waterloo/2018/GEEmix/WINV_RTable2small.RData")
...
# save(results_3,file="WINV_R4_2.RData")
load("WINV_R4_2.RData")
...
# save(Results,file="WINV_RTable42.RData")

load("WINV_RTable32.RData")

reference2 <- Results %>% filter(omega == -1) %>%
  select(c("MSD"))




load("WINV_RTable42.RData")
# save(Results2,file="WINV_RTable42.RData")
library(xtable)




Results2$AARE <- percent(unlist(round(reference2^2/Results2$sdpropose^2,3)))
xtable(Results2,digits = 3)


# load("P:/Work/waterloo/2018/GEEmix/WINV_RTable32.RData")
# Results2 <- Results
# load("P:/Work/waterloo/2018/GEEmix/WINV_RTable2large.RData")
# ResultsIns <- Results[1:6,c("biasprop", "propose_esd", "sdpropose", "CI_propose")]
# colnames(ResultsIns) <- c("bias","esd","MSD","CR")
# Results2$CR <- as.character(Results2$CR)
# ResultsIns$CR <- as.character(ResultsIns$CR)
